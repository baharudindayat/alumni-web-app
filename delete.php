...
<?php 
    ...
    if (isset($_POST['nama'])) {
        $nama = $_POST['nama'];
        $del = "delete from alumni where nama='$nama'";
        mysqli_query($con,$del);
        header("location:editalumniadmin.php");
    }
?>
        ...
        <div class="col-lg-12 col-xl-11">
            ...
            <div class="card-body p-md-5">
                ...
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                    ...
                    <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Hapus Data</p>
                    ...
                    <form class="mx-1 mx-md-4" action="" method="post">
                        ...
                        <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                            <button type="submit" class="btn btn-primary btn-lg" name="submit">Delete</button>
                        </div>
