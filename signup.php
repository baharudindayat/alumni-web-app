<?php
    ...
    if (isset($_POST['username'])) {
        if (isset($_REQUEST['username'])) {
            ...
            $query    = "INSERT into `users` (nama, username, password, email, create_datetime)
                         VALUES ('$nama', '$username', '" . md5($password) . "', '$email', '$create_datetime')";
                ...
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                    ...
                    <form class="mx-1 mx-md-4" action="" method="post">
                        ...
                        <div class="d-flex flex-row align-items-center mb-4">
                            ...
                            <div class="form-outline flex-fill mb-0">
                            <input type="enail" id="form3Example4cd" class="form-control" name="email"/>
                            <label class="form-label" for="form3Example3cd">Email</label>
                            </div>
                        </div>
